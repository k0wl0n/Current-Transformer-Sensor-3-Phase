...
{  char key ;
   ...
   if(key == '2'){ mainMenuPage++; if(mainMenuPage > mainMenuTotal)mainMenuPage = 1;}
   else if(key == '8'){mainMenuPage--;if(mainMenuPage == 0)mainMenuPage = mainMenuTotal;}   
   if(key != mainMenuPageOld){MainMenuDisplay();mainMenuPageOld = mainMenuPage;}
...
void ampere(){
         ...
         if(total >= 0 && total <= RC1){
          digitalWrite(RELAY1,HIGH);
             ...
             lcd.setCursor(9,2);lcd.print("R1");lcd.setCursor(9,3);lcd.print("OFF");
              lcd.setCursor(12,2);lcd.print("R2");lcd.setCursor(12,3);lcd.print("OFF");              
              lcd.setCursor(15,2);lcd.print("R3");lcd.setCursor(15,3);lcd.print("OFF");
            ...
            digitalWrite(RELAY1,LOW);
             ...
             digitalWrite(RELAY3,HIGH);
              ...
              lcd.setCursor(9,2);lcd.print("R1");lcd.setCursor(9,3);lcd.print("ON ");
              lcd.setCursor(12,2);lcd.print("R2");lcd.setCursor(12,3);lcd.print("OFF");              
              lcd.setCursor(15,2);lcd.print("R3");lcd.setCursor(15,3);lcd.print("OFF");
             ...
             digitalWrite(RELAY3,HIGH);
              ...
              lcd.setCursor(9,2);lcd.print("R1");lcd.setCursor(9,3);lcd.print("ON ");
              lcd.setCursor(12,2);lcd.print("R2");lcd.setCursor(12,3);lcd.print("ON ");              
              lcd.setCursor(15,2);lcd.print("R3");lcd.setCursor(15,3);lcd.print("OFF");
             ...
             digitalWrite(RELAY3,LOW);
              ...
              lcd.setCursor(9,2);lcd.print("R1");lcd.setCursor(9,3);lcd.print("ON ");
              lcd.setCursor(12,2);lcd.print("R2");lcd.setCursor(12,3);lcd.print("ON ");              
              lcd.setCursor(15,2);lcd.print("R3");lcd.setCursor(15,3);lcd.print("ON ");
            }
